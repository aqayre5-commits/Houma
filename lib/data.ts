...
export const cityServices: Record<string, CityService> = {
  'casablanca-passeport-marocain': {
    ...
    delayNote: '7 à 15 jours (du délai minimal observé au délai officiel national). Dans les grandes villes, prévoyez plutôt le délai complet, surtout en période de forte demande. Retrait au même bureau après notification par SMS.',
    delayNoteAr: 'من 7 إلى 15 يوماً (من الحد الأدنى الملاحظ إلى الأجل الرسمي الوطني). في المدن الكبرى، من الأفضل توقّع الأجل الكامل، خصوصاً في فترات الضغط. يُستلم من نفس المكتب بعد الإشعار برسالة نصية.',
    onlineLinks: [
  ...
  'casablanca-renouvellement-cnie': {
    ...
    delayNote: '7 à 10 jours (du délai minimal observé au délai officiel national pour les résidents au Maroc). Dans les grandes villes, prévoyez plutôt le délai complet. Retrait au même bureau sur présentation du reçu de dépôt.',
    delayNoteAr: 'من 7 إلى 10 أيام (من الحد الأدنى الملاحظ إلى الأجل الرسمي الوطني للمقيمين بالمغرب). في المدن الكبرى، من الأفضل توقّع الأجل الكامل. يُستلم من نفس المكتب بتقديم وصل الإيداع.',
