    ...
    <div className="container-shell mobile-safe-spacing py-8 md:py-12">
      ...
      <div className="mt-8 rounded-2xl border border-amber-200 bg-amber-50 px-5 py-4">
        ...
        <p className="mt-1.5 text-sm text-amber-900">
          {isAr
            ? 'يبقى الموقع دليلاً خاصاً وغير رسمي. تحقق دائماً من المصدر الرسمي قبل التنقل أو الأداء.'
            : 'Le site reste un guide privé et non officiel. Vérifiez toujours la source officielle avant déplacement ou paiement.'}{' '}
